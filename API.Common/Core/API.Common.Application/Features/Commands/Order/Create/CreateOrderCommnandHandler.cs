...
namespace API.Common.Application.Features.Commands.Order.Create
{
    ...
    IWriteRepository<TDbContext, Domain.Product.Product> writeRepository,
    IReadRepository<TDbContext, Domain.Product.Product> readRepository,
    IWriteRepository<TDbContext, Domain.Orders.Order> orderWriteRepository,
    IWriteRepository<TDbContext, Domain.Balance.UserBalance> writeBalanceWriteRepository,
    IReadRepository<TDbContext, Domain.Balance.UserBalance> readBalanceWriteRepository,
           UserManager<AppUser> userManager
       ) : IRequestHandler<CreateOrderCommandRequest, BaseResponse> where TDbContext : DbContext
    {
        readonly private IWriteRepository<TDbContext, Domain.Product.Product> writeRepository = writeRepository;
        readonly private IReadRepository<TDbContext, Domain.Product.Product> readRepository = readRepository;
        private readonly IWriteRepository<TDbContext, Domain.Orders.Order> _orderRepository = orderWriteRepository;
        private readonly IWriteRepository<TDbContext, Domain.Balance.UserBalance> writeBalanceWriteRepository = writeBalanceWriteRepository;
        private readonly IReadRepository<TDbContext, Domain.Balance.UserBalance> readBalanceWriteRepository = readBalanceWriteRepository;
