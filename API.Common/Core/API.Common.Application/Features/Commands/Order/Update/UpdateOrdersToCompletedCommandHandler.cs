...
{
    public class UpdateOrdersToCompletedCommandHandler<TDbContext> : IRequestHandler<UpdateOrdersToCompletedCommand,Unit>
     where TDbContext : DbContext
    {
        private readonly IWriteRepository<TDbContext, Domain.Orders.Order> _writeRepository;
        private readonly IReadRepository<TDbContext, Domain.Orders.Order> _readRepository;

        public UpdateOrdersToCompletedCommandHandler(
            IWriteRepository<TDbContext, Domain.Orders.Order> writeRepository,
            IReadRepository<TDbContext, Domain.Orders.Order> readRepository)
        {
